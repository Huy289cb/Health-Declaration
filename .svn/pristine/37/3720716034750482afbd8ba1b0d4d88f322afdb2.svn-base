  ...
  render() {
    ...
    return (
      <Dialog open={open} PaperComponent={PaperComponent} maxWidth="md" fullWidth={true}>
        ...
        <DialogTitle style={{ cursor: 'move' }} className="mb-24" id="draggable-dialog-title">
          {this.state.id ? t('general.button.update') : t('general.button.add')} {" " + t("menu.popup")}
        </DialogTitle>
              ...
              <Grid item sm={6} xs={12}>
                ...
                {this.state.shouldOpenSelectParentPopup && (
                  <SelectParentPopup
                    ...
                    selectedItem={
                      (this.state.item != null && this.state.item.parent != null) ? this.state.item.parent : {}
                    }
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <TextValidator
                        ...
                        value={roles}
                        // label={t('user.role')}
                        label={<span><span style={{ color: "red" }}>*</span>{t('user.role.title')}</span>}
