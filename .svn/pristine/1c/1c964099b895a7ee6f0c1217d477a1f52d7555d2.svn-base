              ...
              <div className="flex flex-middle">
                ...
                >
                  <MenuItem style={{ minWidth: 185 }}>
                    <Link className="flex flex-middle" to={ConstantList.HOME_PAGE}>
                      <Icon> home </Icon>
                      <span className="pl-16"> {t('Trang chủ')} </span>
                    </Link>
                  </MenuItem>
                  <MenuItem style={{ minWidth: 185 }}>
                    <Link
                    ...
                    >
                      <Icon> person </Icon>
                      <span className="pl-16"> {t('Tài khoản')} </span>
                    </Link>
                  </MenuItem>
                  <MenuItem
                  ...
                  >
                    ...
                    <span className="pl-16"> {t('Đăng xuất')} </span>
                  </MenuItem>
                </EgretMenu>
              </div>
            </div>
