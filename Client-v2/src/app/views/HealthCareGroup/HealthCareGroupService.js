...
var path = "/api/health_care_group";
...
export const checkDuplicate = (dto) => {
    var url = ConstantList.API_ENPOINT + path + "/checkDuplicate";
    return axios.post(url, dto);
};

export const getListHealthCareGroup = (dto) => {
    const url = ConstantList.API_ENPOINT + path + "/getListHealthCareGroup"
