    ...
    return (
      <Dialog onClose={handleClose} open={open}   PaperProps={{
        ...
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("general.button.upload")}</span>
        </DialogTitle>
        <DialogContent>
            ...
            {this.state.isEmpty?(
              <div>
                  <div 
                    ...
                    >
                      {this.state.isEmpty ? (
                        <span>Thả tệp của bạn ở đây</span>
                      ) : (
                          <h5 className="m-0">
                    ...
                    <label htmlFor="upload-single-file">
                      ...
                      >
                        <div className="flex flex-middle">
                          ...
                          <span>{t('general.button.select_file')}</span>
                        </div>
                      </Button>
                    </label>
                    <input
        ...
        <DialogActions>
            ...
            variant="contained"
            color="secondary"
            onClick={() => handleClose(this.state.user)}>{t('general.button.cancel')}
          </Button>
          <Button
              className="mb-16 mr-16 align-bottom"
              variant="contained"
              color="primary"
              onClick={() => handleUpdate(this.state.blobValue)}>{t('general.button.update')}
            </Button>
        </DialogActions>
      </Dialog>
    );
