...
export default function NicePagination(props) {
    let { handleChangePage, totalPages, setRowsPerPage, pageSizeOption, t, totalElements, page, isSimple } = props;
    ...
    return (
        <div className="nice-pagination-bar">
            <Grid container spacing={2}>
                {!isSimple && <Grid className="row-per-page-selector" item>
