...
const API_PATH_ORG = ConstantList.API_ENPOINT + "/api/userAdministrativeUnit";
const API_PATH_V2 = ConstantList.API_ENPOINT + "/api/users/v2";

export const searchByDto = (dto) => {
  var url = `${API_PATH_V2}/search`;
...
export const changeCodeStatus = () => {
  var url = API_PATH_ORG +"/changeCodeStatus";
  return axios.get(url);
};
